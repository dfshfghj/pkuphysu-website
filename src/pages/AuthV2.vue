        ...
        <form v-show="activeTab === 'register'" class="form-content" @submit="handleRegister">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button type="button" :disabled="isSendingCode || sendCodeCooldown > 0" @click="sendVerificationCode" class="btn-code">
                      {{ sendCodeCooldown > 0 ? `重新发送(${sendCodeCooldown}s)` : '发送验证码' }}
                    </button>
                </div>
            </div>
            <div class="form-group">
                <input v-model="registerForm.code" type="text" class="form-control" placeholder="请输入验证码" maxlength="6" required>
            </div>
            ...
            <div class="extra-links" style="justify-content: center; margin-top: 15px;">
                <label style="font-size: 12px; color: #666;">
                    <input type="checkbox" v-model="agreeTerms" required> 我已阅读并同意 <a href="#">服务条款</a>
                </label>
            </div>
