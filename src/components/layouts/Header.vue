    ...
    >
      ...
      <el-sub-menu index="2">
        ...
        <el-sub-menu index="2-2">
          ...
          <el-menu-item
            index="redirect?redirect=https%3A%2F%2Fdocs.qq.com%2Fdoc%2FDWHF6bWRzTk9tVEZj"
          >
            常用网站
          </el-menu-item>
        </el-sub-menu>
        <el-sub-menu index="3">
          ...
          <el-menu-item
            index="redirect?redirect=https%3A%2F%2Fdocs.qq.com%2Fform%2Fpage%2FDVVFEeUNSUnJNUWFI"
          >
            权益问题收集
          </el-menu-item>
          <el-menu-item
