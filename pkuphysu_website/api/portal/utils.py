...
class DataManager:
    ...
    def load_activity_data(self):
        with open(join(dirname(__file__), "data", "activity.json"), encoding="utf-8") as file:
            data = json.load(file)
    ...
    def load_menu_data(self):
        with open(join(dirname(__file__), "data", "menu.json"), encoding="utf-8") as file:
            data = json.load(file)
    ...
    def load_news_data(self):
        with open(join(dirname(__file__), "data", "news.json"), encoding="utf-8") as file:
            data = json.load(file)
        with open(join(dirname(__file__), "data", "extra_news.json"), encoding="utf-8") as file:
            data += json.load(file)
    ...
    def fetch_news_data(self):
        ...
        with open(join(dirname(__file__), "data", "news.json"), mode="w", encoding="utf-8") as file:
